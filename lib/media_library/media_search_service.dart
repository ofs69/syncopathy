...
//   List<MediaFile> filterVideos(List<MediaFile> videos, String query) {
...
//   bool _evaluateNode(SearchExpressionNode node, MediaFile video) {
//     if (node is RootNode) {
...
//   bool _matchesString(String value, MediaFile video) {
