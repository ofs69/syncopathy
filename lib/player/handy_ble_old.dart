...
import 'package:syncopathy/player/funscript_stream_controller_old.dart';
...
class HandyBleOld extends FunscriptDevice {
  BleDevice? _device;
  ...
  HandyBleOld(this._settings, this._batteryModel) {
