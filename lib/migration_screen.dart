...
class MigrationScreen extends StatefulWidget {
  final Function(BuildContext, MigrationResult) onMigrationComplete;
...
class _MigrationScreenState extends State<MigrationScreen> {
  ...
  Future<void> _startMigration() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        widget.onMigrationComplete(context, MigrationResult.success);
      }
    } catch (e, stacktrace) {
      ...
      if (mounted) {
        ...
        widget.onMigrationComplete(context, MigrationResult.error);
      }
    }
  }
  ...
  void _skipMigration() {
    ...
    widget.onMigrationComplete(context, MigrationResult.skipped);
  }
                ...
                Column(
                  children: [
                    ...
                    OutlinedButton(
                      ...
                      child: const Text(
                        'Skip Migration (Start with Clean Database)',
                      ),
                    ),
                  ],
                ),
      ...
      case MigrationStatus.pending:
        return const Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            Text(
              'Note: If you want to migrate again after skipping or if you encounter issues, you will need to manually delete the "objectbox" directory. You can find the application data directory by going to the settings page and clicking "Open App Data Directory".',
              textAlign: TextAlign.center,
