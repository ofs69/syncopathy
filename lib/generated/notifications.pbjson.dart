...
final $typed_data.Uint8List notificationWifiStatusChangedDescriptor =
...
final $typed_data.Uint8List notificationBleStatusChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationOtaCompleteDescriptor =
    $convert.base64Decode('ChdOb3RpZmljYXRpb25PdGFDb21wbGV0ZQ==');
...
final $typed_data.Uint8List notificationModeChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationBatteryChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHampChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHdspChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspThresholdReachedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspStateChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspLoopingDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspStarvingDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspResumedOnNonStarvingDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHspPausedOnStarvingDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHvpChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationHrppChangedDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationTempHighDescriptor =
    $convert.base64Decode('ChROb3RpZmljYXRpb25UZW1wSGlnaA==');
...
final $typed_data.Uint8List notificationTempOkDescriptor =
    $convert.base64Decode('ChJOb3RpZmljYXRpb25UZW1wT2s=');
...
final $typed_data.Uint8List notificationSliderBlockedDescriptor =
    $convert.base64Decode('ChlOb3RpZmljYXRpb25TbGlkZXJCbG9ja2Vk');
...
final $typed_data.Uint8List notificationSliderUnblockedDescriptor =
    $convert.base64Decode('ChtOb3RpZmljYXRpb25TbGlkZXJVbmJsb2NrZWQ=');
...
final $typed_data.Uint8List notificationLowMemoryErrorDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationLowMemoryWarningDescriptor =
    $convert.base64Decode(
...
final $typed_data.Uint8List notificationWifiScanCompleteDescriptor =
    $convert.base64Decode(
